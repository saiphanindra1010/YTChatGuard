...
exports.createModerationGraph = createModerationGraph;
...
function parseJsonFromLlm(text) {
    ...
    try {
        ...
        if (m) {
            ...
            return {
                ...
                severity: sev === 'low' || sev === 'medium' || sev === 'high' ? sev : 'medium',
    ...
    const bad = low.includes('"isviolation": true') ||
...
//# sourceMappingURL=ModerationGraph.js.map